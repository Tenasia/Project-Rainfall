...
init -1 python hide:
    ...
    config.after_load_transition = ComposedTransition(Dissolve(1.0))

    config.default_fullscreen = True

    config.game_main_transition = ComposedTransition(Dissolve(1.0))
...
init -2 python:
    ...
    renpy.music.register_channel("se1", mixer="game_sfx", loop = False, file_prefix="audio/gsfx/se/", file_suffix=".ogg")
    renpy.music.register_channel("se2", mixer="game_sfx", loop = False, file_prefix="audio/gsfx/se/", file_suffix=".ogg")
    renpy.music.register_channel("ambient", mixer="game_sfx", loop=True, file_prefix="audio/gsfx/ambient/", file_suffix=".ogg", tight=True)
init -1500 python:
